...
model = GenerativeModel(
    ...
    system_instruction = [
        ...
        "Your task is to take a news article as an input and generate a short daily news brief per article given that captures the main points of the article.",
        "Keep the summary short, around 3 sentences, and focus on the key information.",
        "The summary should be clear and presented in an informative and engaging tone for a morning briefing.",
        "Avoid including unnecessary details and focus on the main points of the article. Do not say anything an AI would say. Only provide the summary",
